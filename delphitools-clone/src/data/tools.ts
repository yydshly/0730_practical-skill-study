...
const editorTools: readonly ToolDefinition[] = [
  { id: 'editor', category: 'editor', title: 'Substrata 图片编辑器', englishTitle: 'Substrata Editor', description: '在独立画布中组合图片、文字和标注，并导出常用图片格式。', keywords: ['编辑器', '画布', '图层', '标注', 'Substrata'], workspace: 'editor', mode: 'canvas' },
];
...
const colorTools: readonly ToolDefinition[] = [
  ...
  { id: 'colour-converter', category: 'color', title: '颜色格式转换', englishTitle: 'Colour Converter', description: '在 HEX、RGB 和 HSL 等常见颜色格式之间转换。', keywords: ['HEX', 'RGB', 'HSL', '颜色转换'], workspace: 'color', mode: 'standard' },
  ...
  { id: 'gradient-genny', category: 'color', title: '渐变生成器', englishTitle: 'Gradient Generator', description: '生成线性、角落和网格渐变，并复制 CSS。', keywords: ['渐变', 'CSS', '线性渐变', '网格渐变'], workspace: 'color', mode: 'standard' },
...
const textTools: readonly ToolDefinition[] = [
  ...
  { id: 'paper-sizes', category: 'text', title: '纸张尺寸查询', englishTitle: 'Paper Sizes', description: '查询 ISO、北美和常见印刷纸张规格。', keywords: ['纸张', 'A4', 'ISO', '印刷'], workspace: 'text', mode: 'standard' },
...
const printTools: readonly ToolDefinition[] = [
  { id: 'pdf-preflight', category: 'print', title: 'PDF 印刷预检', englishTitle: 'PDF Preflight', description: '分析 PDF 的页面尺寸、方向、字体和可印刷性问题。', keywords: ['PDF', '预检', '印刷', '字体'], workspace: 'print', mode: 'standard' },
...
const developerTools: readonly ToolDefinition[] = [
  ...
  { id: 'tailwind-cheatsheet', category: 'developer', title: 'Tailwind 速查表', englishTitle: 'Tailwind Cheatsheet', description: '搜索和查看常用 Tailwind CSS 类名。', keywords: ['Tailwind', 'CSS', '类名', '速查表'], workspace: 'developer', mode: 'standard' },
...
const specialTools: readonly ToolDefinition[] = [
  { id: 'shavian-transliterator', category: 'special', title: 'Shavian 转写器', englishTitle: 'Shavian Transliterator', description: '将英文文本转写为 Shavian 字母。', keywords: ['Shavian', '转写', '英文', '特殊文字'], workspace: 'special', mode: 'standard' },
];
